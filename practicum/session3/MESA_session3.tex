...
\begin{itemize}
    \item Choose a mass between 20 M$_\odot$ and 40 M$_\odot$, and change the inlist accordingly. (Note that the inlist will work for higher masses, but will take an increasing amount of time).
